        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              "Atendimento humano — o Humberto atende no WhatsApp, não é robô",
      ...
      <section className="py-24 px-6 text-center hero-gradient relative overflow-hidden">
        ...
        <AnimatedSection className="relative z-10 max-w-2xl mx-auto">
          ...
          <p className="text-blue-200 text-lg mb-10">
            Manda mensagem pro Humberto agora. Em 2 minutos você sabe o valor exato da sua moto — e já pode sair protegido.
          </p>
          <CTAWhatsApp label="📱 FALAR COM O HUMBERTO — PROTEGER MINHA MOTO" variant="green" />
        </AnimatedSection>
      </section>
